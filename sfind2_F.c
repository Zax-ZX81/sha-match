...
int file_size_accum = 0;
int file_progress_int = 0;
...
file_size_mult = (100.000000 / file_size_total);
//fprintf (stderr, "%d\t%f\n", file_size_total, file_size_mult);
	...
	if (sfflags->progress)
		...
		file_progress_int = file_progress;
		fprintf (stderr, "%c%d%%", CGE_RET, file_progress_int);
		}
