...
From there it was all feature-creep, writing support programs and swearing at bugs.  Also learing to use `make`, _GitHub_ and writing `man` pages and read-mes.
